...
config :exsemantica, ExsemanticaWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "FxM29blgn7UGmiRKQ66olfFTxDVOT2aM+NDR+yTB+uNCUS7RMCeet9OHbodNJVd0",
  watchers: [
...
config :exsemantica, ExsemanticaWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "1WFda70sHw4Rh/AeZoJ6S2IGYY3XXqey10ZoyCJALqJ7EZhOO4bjXEEIKAaDLlTH",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:exsemantica, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:exsemantica, ~w(--watch)]}
  ]
