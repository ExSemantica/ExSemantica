defmodule Exsemantica.IRC.Message do
  @moduledoc """
  ...
  # ===========================================================================
  @doc """
  Encodes the default server shutdown packet.
  """
  def encode_shutdown() do
    %Exsemantica.IRC.Message{
      command: "ERROR",
      trailing: encode_quit_reason("Server is shutting down")
    }
  end

  @doc """
  Encodes the default client authentication timeout packet.
  """
  def encode_authentication_timeout() do
    %Exsemantica.IRC.Message{
      command: "ERROR",
      trailing: encode_quit_reason("Authentication timeout")
    }
  end

  # ===========================================================================
  @doc """
  Encodes an `ERROR` packet reason into an iolist.
  """
  def encode_quit_reason(what) do
    [
      "Closing Link: ",
      ExsemanticaWeb.Endpoint.host(),
      " (",
      what,
      ")"
    ]
